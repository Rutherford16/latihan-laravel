...
<body class="bg-stone-800 font-mono">
    <div class="w-3/12 h-screen bg-stone-300 inline-block absolute">
        <img class="bg-stone-600 rounded-full w-20 h-20 mt-2 ms-2 inline-block" src="images/photo.jpg">
        <h2 class="text-2xl ms-1 relative -top-16 left-24 w-2/3">{{$name}}</h2>
    ...
    <div class="w-9/12 p-3 right-0 inline-block absolute">
        @yield('content')
    </div>
</body>
@endsection